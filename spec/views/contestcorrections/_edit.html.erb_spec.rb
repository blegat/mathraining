...
describe "contestcorrections/_edit.html.erb", type: :view, contestcorrection: true do
  ...
  let(:contestsolution) { FactoryBot.create(:contestsolution, contestproblem: contestproblem, official: false, reservation: user.id) }
  let(:contestsolution_official) { FactoryBot.create(:contestsolution, contestproblem: contestproblem, official: true, reservation: user.id) }
  ...
  context "if the solution is official" do      
    it "renders the correct fields and buttons" do
      render partial: "contestcorrections/edit", locals: {contestsolution: contestsolution_official, contestcorrection: contestsolution_official.contestcorrection}
  ...
  context "if the solution is not official" do
    it "renders the correct fields and buttons" do
      render partial: "contestcorrections/edit", locals: {contestsolution: contestsolution, contestcorrection: contestsolution.contestcorrection}
      should have_field("MathInput")
