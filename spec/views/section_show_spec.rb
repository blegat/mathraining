  ...
  describe "visitor" do
    ...
    describe "for a non-fondation section" do
      ...
      it do
        ...
        should have_link(class: "btn-light", text: "1", href: chapter_path(chapter1, :type => 5, :which => question11))
        should have_link(class: "btn-light", text: "2", href: chapter_path(chapter1, :type => 5, :which => question12))
        should have_no_link(class: "btn-light", href: chapter_path(chapter1, :type => 5, :which => question13_offline))
        should have_link(class: "btn-light", text: "3", href: chapter_path(chapter1, :type => 5, :which => question14))
    ...
    describe "for a fondation section" do
      ...
      it do
        ...
        should have_link(theory21.title, href: chapter_path(chapter2, :type => 1, :which => theory21))
        should have_no_link(theory22_offline.title)
        should have_link(class: "btn-light", text: "1", href: chapter_path(chapter2, :type => 5, :which => question21))
        ...
        should have_link(theory31.title, href: chapter_path(chapter3, :type => 1, :which => theory31))
        should have_link(class: "btn-light", text: "1", href: chapter_path(chapter3, :type => 5, :which => question31))
        
        should have_selector("table", id: "chapter#{chapter4.id}", class: "yellowy", text: chapter4.name)
        should have_link(class: "btn-light", text: "1", href: chapter_path(chapter4, :type => 5, :which => question41))
  ...
  describe "user" do
    ...
    describe "having completed two chapters" do
      ...
      it do
        ...
        should have_no_link(theory13_offline.title)
        should have_link(class: "btn-success", text: "1", href: chapter_path(chapter1, :type => 5, :which => question11))
        should have_link(class: "btn-success", text: "2", href: chapter_path(chapter1, :type => 5, :which => question12))
        should have_no_link(href: chapter_path(chapter1, :type => 5, :which => question13_offline))
        should have_link(class: "btn-success", text: "3", href: chapter_path(chapter1, :type => 5, :which => question14))
        
        should have_selector("table", id: "chapter#{chapter2.id}", class: "greeny", text: chapter2.name)
        should have_link(theory21.title, href: chapter_path(chapter2, :type => 1, :which => theory21))
        should have_no_link(theory22_offline.title)
        should have_link(class: "btn-success", text: "1", href: chapter_path(chapter2, :type => 5, :which => question21))
  ...
  describe "admin" do
    ...
    describe "for a non-fondation section" do
      ...
      it do
        ...
        should have_link(class: "btn-warning", text: "!", href: chapter_path(chapter5_offline, :type => 5, :which => question51_offline))
      end
    end
