...
class Submission < ActiveRecord::Base
  ...
  enum status: {:draft             => -1, # draft (only for the student)
                ...
                :generated_with_ai =>  7} # generated by AI (cannot submit for 6 months) 
  ...
  def cheated?
    return self.plagiarized? || self.generated_with_ai?
  end
  ...
  # For a cheated or closed submission: when can we submit a new submission?
